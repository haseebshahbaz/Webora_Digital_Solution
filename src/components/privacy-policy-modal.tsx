            ...
            >
              ...
              <div className="p-6 text-light-gray/80 space-y-6">
                <section>
                  ...
                  <p>
                    Welcome to Webora Digital Solutions. We respect your privacy and are committed to protecting your
                ...
                <section>
                  <h3 className="text-lg font-bold text-white mb-3">2. The Data We Collect About You</h3>
                  <p>
                ...
                <section>
                  <h3 className="text-lg font-bold text-white mb-3">3. How We Use Your Personal Data</h3>
                  <p>
                ...
                <section>
                  <h3 className="text-lg font-bold text-white mb-3">5. Data Retention</h3>
                  <p>
                ...
                <section>
                  <h3 className="text-lg font-bold text-white mb-3">6. Your Legal Rights</h3>
                  <p>
                ...
                <section>
                  <h3 className="text-lg font-bold text-white mb-3">7. Contact Us</h3>
                  <p>
                    If you have any questions about this privacy policy or our privacy practices, please contact us at:
                  </p>
                  <p className="mt-2">
                    <strong className="text-teal">Email:</strong> privacy@weboradigital.com
                    <br />
                ...
                <section>
                  <h3 className="text-lg font-bold text-white mb-3">8. Changes to the Privacy Policy</h3>
                  <p>
